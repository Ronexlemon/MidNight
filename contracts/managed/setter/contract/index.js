...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      ...
      set: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_2.toValue(v_0),
                                      ...
                                      [
                                       ...
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(0n),
                                                                                              alignment: _descriptor_2.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    const tmp_0 = this._publicKey_0(_descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                              partialProofData,
                                                                                              [
                                                                                               { dup: { n: 0 } },
                                                                                               { idx: { cached: false,
  ...
  _publicKey_0(round_0, sk_0) {
    return this._persistentHash_0([new Uint8Array([109, 105, 100, 110, 105, 103, 104, 116, 58, 101, 120, 97, 109, 112, 108, 101, 58, 108, 111, 99, 107, 58, 112, 107, 0, 0, 0, 0, 0, 0, 0, 0]),
                                   __compactRuntime.convertFieldToBytes(32,
                                                                        round_0,
                                                                        'setter.compact line 24 char 45'),
                                   sk_0]);
  }
  _get_0(context, partialProofData) {
    __compactRuntime.assert(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                            ...
                            ===
                            1,
                            'Attempted to get unitialized value');
  ...
  _set_0(context, partialProofData, v_0) {
    ...
    const pk_0 = this._publicKey_0(_descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                             partialProofData,
                                                                                             [
                                                                                              { dup: { n: 0 } },
                                                                                              { idx: { cached: false,
  ...
  _clear_0(context, partialProofData) {
    __compactRuntime.assert(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                            ...
                            ===
                            1,
                            'Attempted to clear unitialized value');
    const sk_0 = this._secretKey_0(context, partialProofData);
    const pk_0 = this._publicKey_0(_descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                             partialProofData,
                                                                                             [
